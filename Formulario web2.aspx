    ...
    <table width="70%" border="0">
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox5" runat="server" MaxLength="8" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox6" runat="server" MaxLength="8" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:TextBox ID="TextBox7" runat="server" MaxLength="8" Width="300px"></asp:TextBox>
        ...
        <tr>
            ...
            <td width="70%">
                ...
                <asp:DropDownList ID="DropDownList1" runat="server" Width="554px">
                </asp:DropDownList>
        ...
        <tr>
            <td colspan="2" align="middle">
                <br />
                <asp:Button ID="Button1" runat="server" Text="Registrar" CssClass="btn btn-primary"  />
                &nbsp;
